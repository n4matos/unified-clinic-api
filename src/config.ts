...
export const config = {
  ...
  jwt: {
    ...
    accessTokenExpiresIn: process.env.JWT_ACCESS_EXPIRES_IN || '15m', // 15 minutos para access token
    refreshTokenExpiresIn: process.env.JWT_REFRESH_EXPIRES_IN || '7d', // 7 dias para refresh token
  },
